...
#
# while True:
#     img = cv2.imread('/home/wangem1/t1.jpg')
#     cv2.imshow("d1", img)
#     img = np_random_color_distort(img)
#     # random_hsv(img,0.5)
#     cv2.imshow("d2",img/255)
#     cv2.waitKey(0)
#
# exit()
...
# hsv_img1 = hsv_img*(0.3,0.4,0.5)
#
# s1 = np.array([[30,2,3],[3,2,80]])
#
#
#
# s1[...,0] = np.clip(s1[...,0],0,20)
# s1[...,1] = np.clip(s1[...,1],0,20)
# s1[...,2] = np.clip(s1[...,2],0,40)
# print(s1)
# exit()
...
#
#
# batch_img = np.empty([4,416,416,3])
# img1 = cv2.imread('/home/wangem1/t1.jpg')
# img1 = cv2.resize(img1,(416,416))
# img2 = cv2.imread('/home/wangem1/22.jpg')
# img2 = cv2.resize(img2,(416,416))
# img3 = cv2.imread('/home/wangem1/123.jpg')
# img3 = cv2.resize(img3,(416,416))
# img4 = cv2.imread('/home/wangem1/t4.jpg')
...
#
#
# batch_boxes = np.empty([4,2,4])
# boxes1=[[20,30,50,70],[60,120,110,200]]
# boxes2=[[220,30,350,70],[160,120,210,200]]
# boxes3=[[120,30,150,70],[30,180,220,240]]
# boxes4=[[230,130,350,170],[160,180,210,200]]
# batch_boxes[0]=boxes1
# batch_boxes[1]=boxes2
# batch_boxes[2]=boxes3
# batch_boxes[3]=boxes4
#
# # cv2.rectangle(img1, tuple(boxes1[0][0:2]), tuple(boxes1[0][2:4]), (0,255,255), 3)
# # cv2.rectangle(img1, tuple(boxes1[1][0:2]), tuple(boxes1[1][2:4]), (0,255,255), 3)
# # cv2.rectangle(img2, tuple(boxes2[0][0:2]), tuple(boxes2[0][2:4]), (0,255,255), 3)
# # cv2.rectangle(img2, tuple(boxes2[1][0:2]), tuple(boxes2[1][2:4]), (0,255,255), 3)
# # cv2.rectangle(img3, tuple(boxes3[0][0:2]), tuple(boxes3[0][2:4]), (0,255,255), 3)
# # cv2.rectangle(img3, tuple(boxes3[1][0:2]), tuple(boxes3[1][2:4]), (0,255,255), 3)
# # cv2.rectangle(img4, tuple(boxes4[0][0:2]), tuple(boxes4[0][2:4]), (0,255,255), 3)
# # cv2.rectangle(img4, tuple(boxes4[1][0:2]), tuple(boxes4[1][2:4]), (0,255,255), 3)
# # cv2.imshow('s1', img1)
# # cv2.imshow('s2', img2)
# # cv2.imshow('s3', img3)
# # cv2.imshow('s4', img4)
#
# while True:
#     # four_img, four_boxes,one_img, one_boxes = load_mosaic(batch_img,batch_boxes)
#     # random_hsv(one_img)
#     img1 = cv2.imread('/home/wangem1/t1.jpg')
#     img1 = cv2.resize(img1, (416, 416))
#
#     img1 = np_random_color_distort(img1)
#
#     boxes1 = [[20, 30, 50, 70], [60, 120, 110, 200]]
#     boxes1 = np.array(boxes1)
#     random_left_right_flip(img1,boxes1)
#     one_img,one_boxes = img1,boxes1
#
#
#
#     # for i in range(len(four_boxes)):
#     #     cv2.rectangle(four_img, tuple(four_boxes[i][0:2].astype(np.int32)), tuple(four_boxes[i][2:4].astype(np.int32)), (0,255,255), 3)
#     for i in range(len(one_boxes)):
#
#         cv2.rectangle(one_img, tuple(one_boxes[i][0:2].astype(np.int32)), tuple(one_boxes[i][2:4].astype(np.int32)),
#                       (0, 255, 255), 3)
#         # cv2.imshow('d2', one_img / 255)
#         # cv2.waitKey()
#
#     # cv2.imshow('d1',four_img)
#     # one_img = cv2.resize(one_img,(416,416))
#     cv2.imshow('d2', one_img/255)
#     cv2.waitKey()
#
# exit()
...
# boxes = np.array([[0.1,0.3,0.5,0.6],[0.5,0.7,0.7,0.9]])
#
# new_img,new_boxes = random_affine(img, targets=boxes, degrees=10, translate=.1, scale=.1, shear=10, border=0)
# print(new_boxes)
# new_boxes_int = new_boxes*np.tile(img.shape[0:2][::-1],[2])
#
# cv2.rectangle(new_img, tuple(new_boxes_int[0][0:2].astype(np.int32)), tuple(new_boxes_int[0][2:4].astype(np.int32)), (0,255,255), 3)
# cv2.rectangle(new_img, tuple(new_boxes_int[1][0:2].astype(np.int32)), tuple(new_boxes_int[1][2:4].astype(np.int32)), (0,255,255), 3)
# cv2.imshow('d1',new_img)
# cv2.waitKey()
# exit()
#
# boxes_int = boxes*np.tile(img.shape[0:2][::-1], [2])
# new_img, new_boxes = random_left_right_flip(img,boxes)
# new_boxes_int = new_boxes*np.tile(img.shape[0:2][::-1],[2])
#
# cv2.rectangle(img, tuple(boxes_int[0][0:2].astype(np.int32)), tuple(boxes_int[0][2:4].astype(np.int32)), (0,255,0), 3)
# cv2.rectangle(img, tuple(boxes_int[1][0:2].astype(np.int32)), tuple(boxes_int[1][2:4].astype(np.int32)), (0,255,0), 3)
# cv2.rectangle(new_img, tuple(new_boxes_int[0][0:2].astype(np.int32)), tuple(new_boxes_int[0][2:4].astype(np.int32)), (0,255,255), 3)
# cv2.rectangle(new_img, tuple(new_boxes_int[1][0:2].astype(np.int32)), tuple(new_boxes_int[1][2:4].astype(np.int32)), (0,255,255), 3)
# cv2.imshow('d1',img)
# cv2.imshow('d2',new_img)
# cv2.waitKey()
#
#
# exit()
