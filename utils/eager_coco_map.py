...
class EagerCocoMap():
    def __init__(self, validation_generator,model,args):
        self.args = args
        ...
        for batch_img, batch_boxes, batch_valids in self.validation_generator:
    ...
    def eval(self):
        ...
        validation_generator_tqdm = tqdm(self.validation_generator, total=len(self.validation_generator))
