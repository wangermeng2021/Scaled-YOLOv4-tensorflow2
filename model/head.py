...
def head_down(backbone_output_layers):
    ...
    for layer_index in range(2,len(backbone_output_layers)+1):
        head_down_output_layer = conv2d_bn_mish(head_down_output_layer, head_down_output_layer.shape[-1] // 2,(1, 1),
...
def head_up(head_down_output_layers):
    ...
    for layer_index in range(2, len(head_down_output_layers) + 1):
        ...
        head_up_output_layers = conv2d_bn_mish(head_up_output_layers, head_up_output_layers.shape[-1]*2, (3,3), strides=(2,2), padding='valid',
